export default {
  ...
  'userandregister.name.required': '请输入用戶名',
  ...
  'userandregister.role.required': "请输入用戶角色",
  'userandregister.role.wrong-format': '用戶角色不存在',
  ...
  'userandregister.name.placeholder': '用戶名',
  ...
  'userandregister.role.placeholder': '用戶角色',
